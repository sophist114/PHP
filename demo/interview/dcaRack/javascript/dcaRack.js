(function($){
 	$.fn.extend({ 
 		...
 		buildDCA: function(options) {
             ...
             var defaults = {
                 ...
                 rackId: "DCA1001",
                 rackImage: "images/emc-greenplum-appliance.png",
                 dcaType:"Full",
    ...
    var buildLayout = function(rackContent){
        ...
        var layout = null;
                ...
                layout = layout + '<li id="rack'+(index+1)+'" class="dca">'
                        ...
                        + '<div class="wrap"><div class="rackname">DCA '+(index+1)+'</div><br /><img class="img-swap" title="Open DCA" src="images/openrack.png" /> <img class="rotate-swap" title="Rotate" src="images/rotate.png" /></div></div></li>';
                });
    ...
    var handleRackImgClick = function(rackContent){
        ...
        $('.dcaImg.front').click({rackDt:rackContent},function(e) {
            ...
            $('#'+rackname).find(".img-swap").attr('src', 'images/closerack.png').toggleClass("on");
